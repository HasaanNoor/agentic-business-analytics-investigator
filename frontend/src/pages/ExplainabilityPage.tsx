...
export function ExplainabilityPage() {
  const { data, error, loading, retry } = useAsyncData(() => dataProvider.getExplanations(500));
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description={
          isStaticDataMode
            ? 'SHAP explanations loaded from static demo fixtures describe model behavior from a pre-generated run and do not prove real-world causation.'
            : 'SHAP describes how the selected model used features. It explains model behavior and does not prove real-world causation.'
        }
      />
