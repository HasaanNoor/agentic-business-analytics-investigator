"""Optional LLM-backed Support Agent."""
...
def analyze_support_llm(
    ...
    return run_llm_specialist("support", "Customer Support Agent", incident, kpis, forecasts, shap_importance, config, client, retrieved_incidents)
