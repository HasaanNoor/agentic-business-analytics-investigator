"""Optional LLM-backed Logistics Agent."""
...
def analyze_logistics_llm(
    ...
    return run_llm_specialist("logistics", "Logistics Agent", incident, kpis, forecasts, shap_importance, config, client, retrieved_incidents)
