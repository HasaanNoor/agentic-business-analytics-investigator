...
FILE_SPECS: dict[str, FileSpec] = {
    "sales_metrics_daily.csv": FileSpec(
        ...
        rate_columns=("conversion_rate", "expected_refund_rate", "expected_checkout_failure_rate"),
    ),
    ...
    "shipping_delays_daily.csv": FileSpec(
        ...
        nonnegative_columns=("shipments", "delayed_shipments", "warehouse_backlog", "avg_delay_hours"),
        rate_columns=("delay_rate", "carrier_capacity_utilization"),
    ),
